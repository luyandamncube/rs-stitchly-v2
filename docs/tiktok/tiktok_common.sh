...
_TIKTOK_CALLER_ENV_FILE="${TIKTOK_ENV_FILE:-}"
_TIKTOK_CALLER_OUT_DIR="${TIKTOK_OUT_DIR:-}"
_TIKTOK_CALLER_TOKEN_FILE="${TIKTOK_TOKEN_FILE:-}"
_TIKTOK_CALLER_CODE_POLL_TIMEOUT_SECONDS="${TIKTOK_CODE_POLL_TIMEOUT_SECONDS:-}"
_TIKTOK_CALLER_CODE_POLL_INTERVAL_SECONDS="${TIKTOK_CODE_POLL_INTERVAL_SECONDS:-}"
_TIKTOK_CALLER_OPEN_BROWSER="${TIKTOK_OPEN_BROWSER:-}"
...
if [ -n "$_TIKTOK_CALLER_ENV_FILE" ]; then
  TIKTOK_ENV_FILE="$_TIKTOK_CALLER_ENV_FILE"
fi

if [ -n "$_TIKTOK_CALLER_OUT_DIR" ]; then
  TIKTOK_OUT_DIR="$_TIKTOK_CALLER_OUT_DIR"
fi

if [ -n "$_TIKTOK_CALLER_TOKEN_FILE" ]; then
  TIKTOK_TOKEN_FILE="$_TIKTOK_CALLER_TOKEN_FILE"
elif [ -n "$_TIKTOK_CALLER_OUT_DIR" ]; then
  TIKTOK_TOKEN_FILE="$TIKTOK_OUT_DIR/tiktok_tokens.json"
fi

if [ -n "$_TIKTOK_CALLER_CODE_POLL_TIMEOUT_SECONDS" ]; then
  TIKTOK_CODE_POLL_TIMEOUT_SECONDS="$_TIKTOK_CALLER_CODE_POLL_TIMEOUT_SECONDS"
fi

if [ -n "$_TIKTOK_CALLER_CODE_POLL_INTERVAL_SECONDS" ]; then
  TIKTOK_CODE_POLL_INTERVAL_SECONDS="$_TIKTOK_CALLER_CODE_POLL_INTERVAL_SECONDS"
fi

if [ -n "$_TIKTOK_CALLER_OPEN_BROWSER" ]; then
  TIKTOK_OPEN_BROWSER="$_TIKTOK_CALLER_OPEN_BROWSER"
fi
